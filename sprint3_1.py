...
with DAG(dag_id="Sprin4_Task71", schedule_interval="@daily", default_args=default_args, catchup=False) as dag:
    ...
    with TaskGroup(group_id='group1') as fg1:
        f1 = FileSensor(
            ...
            fs_conn_id="fs_local", filepath=str(datetime.now().date()) + "customer_research.csv",
            poke_interval=5,
        ...
        f2 = FileSensor(
            ...
            fs_conn_id="fs_local", filepath=str(datetime.now().date()) + "user_order_log.csv",
            poke_interval=5,
        ...
        f3 = FileSensor(
            ...
            fs_conn_id="fs_local", filepath=str(datetime.now().date()) + "user_activity_log.csv",
            poke_interval=5,
    ...
    with TaskGroup(group_id='group2') as fg2:
        load_customer_research = PythonOperator(
            ...
            op_kwargs={
                'filename': str(datetime.now().date()) + "customer_research.csv",
        ...
        load_user_order_log = PythonOperator(
            ...
            python_callable=load_file_to_pg,
            op_kwargs={
                'filename': str(datetime.now().date()) + "user_order_log.csv",
        ...
        load_user_activity_log = PythonOperator(
            ...
            python_callable=load_file_to_pg,
            op_kwargs={
                'filename': str(datetime.now().date()) + "user_activity_log.csv",
        ...
        load_price_log = PythonOperator(
            ...
            python_callable=load_file_to_pg,
            op_kwargs={
                'filename': str(datetime.now().date()) + "price_log.csv",
